...
export default function SearchItem() {
  ...
  const hot = api.hotel.getAll.useQuery() ;
    ...
    const hotels = api.hotel.getByCountry.useQuery(typeof slug === 'string' ? slug : '');
        ...
        return (
          <Link href={`/hotels/${hotel.id}`} key={hotel.id}>
            <div className="searchItem border border-gray-300 p-[10px] rounded-[5px] flex justify-between gap-[20px] mb-[20px]">
              <Image src={hotel.image} alt="" className="SearchItemImg w-[200px] h-[200px] object-cover" width={200} height={200} />
